"""
Django settings for ultimate_security_s_41224 project.
...
ROOT_URLCONF = 'ultimate_security_s_41224.urls'
...
WSGI_APPLICATION = 'ultimate_security_s_41224.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ultimate_security_s_41224 API",
    "DESCRIPTION": "API documentation for ultimate_security_s_41224 App",
    "VERSION": "v1",
}
